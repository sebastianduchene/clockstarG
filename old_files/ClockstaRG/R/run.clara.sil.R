run.clara.sil <-
function(clus.matrix.name, out.clus.name = "out_clus_sil.txt", k.range = NULL){
  ...
  print("I WILL START COMPUTING SILHOUETTE WIDTHS WITH CLARA")
  print("NOTE THAT SILHOUETTES ARE NOT COMPUTED FOR K = 1")	
